...
def pbDrawStatsPentagonBaseBorder(sprite,centerX,centerY,radius,borderThickness,outlineColor,bgdColor)
	sprite.draw_pentagon(centerX,centerY,radius*2,radius*2,outlineColor,nil,true)
	sprite.draw_pentagon(centerX,centerY,radius*2-borderThickness,radius*2-borderThickness,bgdColor,nil,true,outlineColor)
	# sprite.draw_pentagon_with_values(centerX,centerY,radius*2-12,radius*2-12,chartColor,255,stats,nil,true,false)
end
...
def pbDrawStatsPentagonFlavor(sprite,stats,max,centerX,centerY,radius,borderThickness,chartColor)
	# sprite.draw_pentagon(centerX,centerY,radius*2,radius*2,outlineColor,nil,true)
	# sprite.draw_pentagon(centerX,centerY,radius*2-12,radius*2-12,bgdColor,nil,true,outlineColor)
	sprite.draw_pentagon_with_values(centerX,centerY,radius*2-borderThickness,radius*2-borderThickness,chartColor,max,stats,nil,true,false)
end